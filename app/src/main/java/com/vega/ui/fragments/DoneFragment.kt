...
import com.vega.databinding.FragmentDoneBinding
...
class DoneFragment : Fragment() {
    ...
    private fun setupSwipeGestures() {
        ...
        itemTouchHelper.attachToRecyclerView(binding.rvDoneTasks)
    }
                    ...
                    viewModel.doneTasks.collect { tasks ->
                        ...
                        adapter.submitList(tasks) {
                            if (isInitialEmission) {
                                runEntranceStaggerAnimation(binding.rvDoneTasks)
                            }
                        }
                        if (tasks.isEmpty()) {
                            binding.layoutEmptyState.visibility = View.VISIBLE
                            binding.rvDoneTasks.visibility = View.GONE
                        } else {
                            binding.layoutEmptyState.visibility = View.GONE
                            binding.rvDoneTasks.visibility = View.VISIBLE
                        }
                    }
                }
